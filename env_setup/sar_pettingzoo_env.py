...
class SARPettingZooEnv(ParallelEnv):
    ...
    def __init__(
        ...
        actor_dim = self.cfg.obs.actor_dim  # 80 with the default observation config

        if reward_override is not None:
            self._base_env.baseline_reward = reward_override
    ...
    def step(
        ...
        Args:
            actions: {agent_name: action_array}
                     e.g., {"uav_0": [0.5, 0.3, -0.1, 0.0], "uav_1": ...}
